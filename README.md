# My Awesomeness  [![build](https://github.com/CassieMarie0728/my-awesomeness/workflows/build/badge.svg)](https://github.com/CassieMarie0728/my-awesomeness/actions)
...
- [modded-android/external](https://github.com/modded-android/external) - The absolutely massive external repo for modded android. Kinda gross but kinda needed too. I have a goal of internalizing most of these things, replacing and rewriting them. Wish me luck this repo is huge :)
- [obsproject/obs-studio](https://github.com/obsproject/obs-studio) - OBS Studio - Free and open source software for live streaming and screen recording
- [onlyfang/VBoxVmService](https://github.com/onlyfang/VBoxVmService) - Windows Service to run VirtualBox VMs automatically
...
- [lalakii/AndroidKeyGen](https://github.com/lalakii/AndroidKeyGen) - 安卓APK签名证书生成器，更加简单快速地生成 Android 签名证书。使用 C# ( .Net Framework) 实现，不依赖 Java 环境，支持1位数短密码。https://androidkeygen.sourceforge.net
...
- [Xyl2k/c0decalc-cutlet-maker-keygen](https://github.com/Xyl2k/c0decalc-cutlet-maker-keygen) - Keygen for the ATM Malware Cutlet Maker
...
- [gpt4free/g4f.exe](https://github.com/gpt4free/g4f.exe) - GPT4Free (g4f) - Windows Launcher
- [jcrvnx/android-hacking-tools](https://github.com/jcrvnx/android-hacking-tools) - This is the original repository for Android enthusiasts and developers focused on creating game cheats, modded APKs, and related tools. It is specifically tailored for building advanced Game Mod Menus and similar customizations.
...
- [open-build/web-studio-pages](https://github.com/open-build/web-studio-pages) - A simple visual editor for working with GitHub pages.

## Elm

- [krksgbr/glyphcollector](https://github.com/krksgbr/glyphcollector) - 
...
- [Azure/wordpress-linux-appservice](https://github.com/Azure/wordpress-linux-appservice) - 
...
- [siyuan-note/widget-sample](https://github.com/siyuan-note/widget-sample) - SiYuan widget sample
...
- [fossasia/phimpme-android](https://github.com/fossasia/phimpme-android) - Photo Imaging and Picture Editor
- [github-af/SmartPGP](https://github.com/github-af/SmartPGP) - SmartPGP is a JavaCard implementation of the OpenPGP card specifications
...
- [open-keychain/openpgp-api](https://github.com/open-keychain/openpgp-api) - OpenPGP API library
- [ozgurcanarican/NetSpy](https://github.com/ozgurcanarican/NetSpy) - NetSpy is an information gathering tool that checks if someone you know the name or username, has an account on more than 20 different social media platforms.
- [pgpainless/pgpainless](https://github.com/pgpainless/pgpainless) - Simple to use OpenPGP API based on Bouncy Castle
...
- [warren-bank/Android-RTSP-IPCam-Viewer](https://github.com/warren-bank/Android-RTSP-IPCam-Viewer) - Android app to view RTSP and RTMP IP camera video streams.
- [wdavidjohn/Exploit.in-EmailSearch](https://github.com/wdavidjohn/Exploit.in-EmailSearch) - This program will parse through the Exploit.in database dump and return the specific E-mail addresses and passwords that you are looking for.
...
- [SKS-Keyserver/sks-keyserver](https://github.com/SKS-Keyserver/sks-keyserver) - OpenPGP keyserver
...
- [dokuwiki/codesearch.dokuwiki.org](https://github.com/dokuwiki/codesearch.dokuwiki.org) - Download all DokuWiki extensions in one go and make them searchable
...
- [igniterealtime/Openfire-Social](https://github.com/igniterealtime/Openfire-Social) - Provides a social network with member profiles, activity streams, user groups, messaging, blogs and more by integrating Openfire with WordPress, bbPress and BuddyPress
...
- [rtCamp/wordpress-skeleton](https://github.com/rtCamp/wordpress-skeleton) - A base repository structure for rtCamp's WordPress sites, pre-configured to use Github Actions
...
- [singpolyma/social-search-me](https://github.com/singpolyma/social-search-me) - The Open Web's people search engine
...
- [CameliaD/File-Organizer](https://github.com/CameliaD/File-Organizer) - This Git repository contains a PowerShell script with a user-friendly interface to automatically organize cluttered files into folders by year and month. Ideal for individuals who struggle with file organization, the tool frees up time and simplifies finding and accessing files. 
...
- [Shekswess/ai-project-template](https://github.com/Shekswess/ai-project-template) - This is the code repository for the AI project template. The idea of this template is to have a code framework prepared for any AI/ML/MLOps/LLMOps project
- [Significant-Gravitas/AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) - AutoGPT is the vision of accessible AI for everyone, to use and to build on. Our mission is to provide the tools, so that you can focus on what matters.
- [SnipSaveCLI/SnipSaveCLI](https://github.com/SnipSaveCLI/SnipSaveCLI) - 
...
- [rstudio/rmarkdown-cookbook](https://github.com/rstudio/rmarkdown-cookbook) - R Markdown Cookbook. A range of tips and tricks to make better use of R Markdown.
...
- [Alexjr2/Frida_Termux_Installation](https://github.com/Alexjr2/Frida_Termux_Installation) - build frida for android arch : arm, arm64, x86 and x86_64
...
- [bytezcrew/wfdroid-termux](https://github.com/bytezcrew/wfdroid-termux) - Android Terminal Web-Hacking Tools
...
- [h4ck3r0/Apktool-termux](https://github.com/h4ck3r0/Apktool-termux) - Latest Apktool For Termux , Version : 3.0.2 , Maintained
...
- [1fexd/setup-modded-android-jar](https://github.com/1fexd/setup-modded-android-jar) - Replace android.jar with modded version by Reginer
...
- [CassieMarie0728/jekyll-forge](https://github.com/CassieMarie0728/jekyll-forge) - A production-ready visual editor, publishing dashboard, and GitHub-powered CMS for Jekyll blogs built for Android.
...
- [HackWithSumit/KaliNethunter-Rootless](https://github.com/HackWithSumit/KaliNethunter-Rootless) - NetHunter Rootless Edition. Maximum flexibility with no commitment. Install Kali NetHunter on any stock, unrooted Android device without  voiding the warranty.
...
- [refactoringhq/portent-vault-template](https://github.com/refactoringhq/portent-vault-template) - Starter vault template with the default Portent type definitions
- [restyler/awesome-n8n](https://github.com/restyler/awesome-n8n) - Useful n8n resources: list of community nodes and tutorials
- [room101-dev/Grand-Ultimate-BTC-Hacker](https://github.com/room101-dev/Grand-Ultimate-BTC-Hacker) - The most advanced bitcoin hacking system on the planet. It works, and it will find 'lost' bitcoins all day long.
